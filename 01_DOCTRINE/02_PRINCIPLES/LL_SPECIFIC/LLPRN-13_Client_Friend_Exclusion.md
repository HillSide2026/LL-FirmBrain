...
# LLPRN-13 - Client-Friend Exclusion
...
2. Friend-referred client: if a friend refers a client to you, that client's category is determined by their own relationship with you, not by the referring friend's relationship with you. The friend's goodwill does not extend to the referred party. They are a client; apply LLPRN-07 and LLPRN-11 accordingly.
