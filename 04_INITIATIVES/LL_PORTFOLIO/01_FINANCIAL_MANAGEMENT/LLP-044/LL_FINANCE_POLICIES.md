---
id: 06_financial_portfolio__ll_finance_policies_md
title: LL Finance Policies
owner: ML1
status: draft
...
Record ML1-approved finance decision rules for Levine Law.

Policies are different from principles and invariants:

- Principles explain the finance lens.
- Invariants state durable truths and constraints.
- Policies state how LL will decide or act.
