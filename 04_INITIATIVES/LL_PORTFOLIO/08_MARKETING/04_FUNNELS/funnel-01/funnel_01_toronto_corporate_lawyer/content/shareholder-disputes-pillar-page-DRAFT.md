---
id: f01__shareholder-disputes-pillar-page
title: Shareholder Disputes — Pillar Page Draft
type: pillar-page
status: draft
funnel: funnel-01
product_link: Shareholder Dispute Readiness Guide ($9)
...
## Copy Draft for ML1 Review

> Subject to brand voice and page design review before publication.
> Layout annotations in [BRACKETS] are for the web builder, not for display.

---

## [LAYOUT: HERO — full-width, left-aligned, high whitespace]
...
## [LAYOUT: SECTION 1 — standard text block, no visuals]
[ANCHOR: #what-is-a-shareholder-dispute]
...
[LAYOUT: CALLOUT BOX — grey background, restrained styling]
> "Most disputes are recognized legally only after they have already been developing operationally."

---

## [LAYOUT: SECTION 2 — two-column: left narrative, right structured bullets]
[ANCHOR: #how-disputes-start]
...
## [LAYOUT: SECTION 3 — card grid, 3 cards]
[ANCHOR: #early-warning-signs]
...
[LAYOUT: inline text link below cards]
See [how these situations actually develop](/shareholder-disputes/partnership-not-tense).

---

## [LAYOUT: SECTION 4 — text + divider + structured subsections]
...
[LAYOUT: small text compliance note]
...
## [LAYOUT: SECTION 5 — numbered list]
...
## [LAYOUT: SECTION 6 — staged blocks or timeline-style]
[ANCHOR: #when-to-involve-counsel]
...
[LAYOUT: emphasized line]
**Most people seek legal advice after the record has already been shaped.**

---

## [LAYOUT: SECTION 8 — minimal list, no cards]

**Related Reading**

- [A Business Partnership Is Rarely "Tense." It Is Usually Entering a Legally Meaningful Phase.](/shareholder-disputes/partnership-not-tense)
- [Early Signs a Business Partner Relationship Is Breaking Down](/shareholder-disputes/early-signs)
- [What to Document When a Shareholder Dispute Is Emerging](/shareholder-disputes/documentation)
- [Can a Business Partner Be Removed From a Company in Ontario?](/shareholder-disputes/removing-partner-ontario)
- [When a Shareholder Agreement No Longer Reflects Reality](/shareholder-disputes/shareholder-agreement-reality)

---

## [LAYOUT: SECTION 9 — narrow text block, light background, visually separated, positioned before footer]
...
## [LAYOUT: FOOTER — standard firm navigation, no CTA emphasis]
...
**Visual Hierarchy**
- Heavy whitespace throughout
- No aggressive colors; callout boxes use grey background only
- Callouts used once (Section 1 only)
- Sticky table of contents optional (right side, desktop only)

**SEO Structure**
- H1: Shareholder Disputes
- H2s as drafted above
- Internal links embedded contextually within body (Sections 3, 6, 8) — not grouped at bottom only
- Primary target: "shareholder dispute Ontario"

**Interaction Design**
- Smooth scroll to anchor IDs
- Anchor IDs: #what-is-a-shareholder-dispute, #how-disputes-start, #early-warning-signs, #legal-framework, #common-mistakes, #when-to-involve-counsel

**What This Page Explicitly Avoids**
- No testimonials or case results
- No urgency language
- No "book a consultation" framing
- No "we help" language
- Compliance note in Section 4 is mandatory
